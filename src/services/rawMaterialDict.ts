...
export class RawMaterialsDictService {
  ...
  public static getDefaultSeedList(): RawMaterialDictItem[] {
    return [
      ...
      { name: "紫菜", category: FoodCategory.VEGETABLE, unit: "袋", remark: "30g/袋" },//
      ...
      { name: "酵母", category: FoodCategory.VEGETABLE, unit: "袋", remark: "500g/袋" },
      { name: "豆沙", category: FoodCategory.VEGETABLE, unit: "斤", remark: "" },
      { name: "白菜", category: FoodCategory.VEGETABLE, unit: "斤", remark: "散装" },
      { name: "木耳", category: FoodCategory.VEGETABLE, unit: "斤", remark: "" },
      ...
      { name: "香菇", category: FoodCategory.VEGETABLE, unit: "斤", remark: "散装" },
      { name: "粉丝", category: FoodCategory.VEGETABLE, unit: "袋", remark: "400g/袋" },
      { name: "茄子", category: FoodCategory.VEGETABLE, unit: "斤", remark: "散装" },
      { name: "虾皮", category: FoodCategory.VEGETABLE, unit: "斤", remark: "散装" },
      ...
      { name: "豆油", category: FoodCategory.GRAIN_OIL, unit: "桶", remark: "" },
      ...
      { name: "挂面", category: FoodCategory.GRAIN_OIL, unit: "斤", remark: "" },
      ...
      { name: "酱油", category: FoodCategory.SEASONING, unit: "桶", remark: "" },
      { name: "蚝油", category: FoodCategory.SEASONING, unit: "桶", remark: "" },
      { name: "生抽", category: FoodCategory.SEASONING, unit: "桶", remark: "" },
      { name: "老抽", category: FoodCategory.SEASONING, unit: "桶", remark: "" },
      ...
      { name: "火腿肠", category: FoodCategory.MEAT, unit: "捆", remark: "10/捆" },
      ...
      { name: "香梨", category: FoodCategory.FRUIT, unit: "斤", remark: "" },
      { name: "西瓜", category: FoodCategory.FRUIT, unit: "斤", remark: "散装" },
      { name: "苹果", category: FoodCategory.FRUIT, unit: "斤", remark: "" },
