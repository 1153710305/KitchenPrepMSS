...
export const StatisticsPanel: React.FC<StatisticsPanelProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      {/* 2格宽: 核心财务趋势看板 */}
      <div className="lg:col-span-2 bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
        <div>
      ...
      {/* 1格宽: 品类配比分布及痛点 */}
      <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
        <div>
      ...
      <div className="lg:col-span-3 bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
